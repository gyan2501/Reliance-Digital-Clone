...
useEffect(() => {
      ...
      <hr />
        <Flex gap={"5px"}>
            ...
            <Box boxShadow={"md"} padding={"10px"} textAlign="left" >
                ...
                <Text mt={"12px"} mb={"12px"} fontSize='xl'>{g.name}</Text>
               
                <Flex><Checkbox defaultChecked>Add to Compare</Checkbox> </Flex>
               <br />
                <hr/>
  ...
  <Text mb={"5px"} fontWeight="bold">Gain more with offers (8)</Text>
  ...
  <ListItem mb={"10px"}> Warranty: 1 Year manufacturer warranty</ListItem>
  <Text mb={"5px"} fontWeight="bold">Return Policy</Text>
  ...
  <ListItem>All accessories, product & packaging need to be returned in original condition.</ListItem>
                    ...
                    <Flex paddingLeft="20px" flexDirection="column" justifyContent="space-between">
                        <Text fontSize='2xl' color="#28316b">Deal Price: ₹{g.offer-(g.offer * g.save/100)}.00</Text>
                        <Flex><Text>MRP:{" "} </Text><Text as='del'> ₹{g.offer}</Text></Flex>
                        <Flex color="green"><Text>You Save :</Text><Text>{g.save}{"%"} (₹{g.offer * g.save/100})</Text></Flex>
                        <Text  fontWeight={"bold"}>EMIs (Credit Cards) from ₹4100.54/month |<Text color={"#337ab7"}>View Plans</Text> </Text>
                        ...
                        <Flex>
                        <Button borderRadius="none" colorScheme='red' width="200px" height={"50px"}
                        onClick={()=>{dataAdd();navigate("/cart");}}
                        >ADD TO CART</Button>
                        <Spacer/>
                        <Button borderRadius="none" colorScheme='orange' width="200px" height={"50px"}>BUY NOW</Button>
                        <Spacer/>
                        </Flex>
                    </Flex>
                </Flex>
